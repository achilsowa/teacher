 ...
 */
class Classroom_Teacher extends \Entity\Classroom_Teacher implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'active', 'creation', 'year', 'classroom', 'teacher');
    }
