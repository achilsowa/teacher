...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="<?php echo $base ?>css/sign.css" />
    ...
    <body class="login-page">
      ...
      <div id="login" class="animated bounceIn">
        ...
        <div class="login-wrapper">
		  ...
		  <div class="col-lg-6 col-md-6" style="color:#f55;">
		    ...
		    action="<?php echo $base?>register/signin" >
                <div class="form-group">
                  <div class="col-lg-12">
      ...
      <script src="<?php echo $base ?>js/libs/tab.js"></script>
      <?php if(isset($sign) && $sign == "up") { ?>
	    <script type="text/javascript">
	      $('#register').addClass('active in');
	      $('#log-in').removeClass('active in');
	    </script>
	    <?php }
	    ?>
      <!--[if lt IE 9]>
